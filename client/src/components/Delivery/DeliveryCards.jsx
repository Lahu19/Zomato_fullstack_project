...
const DeliveryCards = (props) => {
  return (
    <div className="w-full p-4  md:w-1/2 lg:w-1/3 xl:1">
      <div className="w-full h-full bg-white rounded-2xl drop-shadow-md">
        ...
        <div className="p-3 flex flex-col gap-2">
          ...
          <p className="text-sm font-light text-gray-600">
            Any food that you want we deliver at your door step.
          </p>
          <div className="mt-4">
            <hr />
          </div>
          <div>
            <span className="flex gap-2 items-center">
              <s className="text-gray-400 font-light">₹500</s>
              <strong>₹320</strong>
            </span>
            <p className="text-gray-400 font-light">The Food That You Love</p>
          </div>
        </div>
      </div>
    </div>
